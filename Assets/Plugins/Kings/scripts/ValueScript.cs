...
public class ValueScript : MonoBehaviour {
	...
	public void clearPreviewValues(){
		...
		if (UserInterface.valueChangePreview.valueChangeImage != null) {
			UserInterface.valueChangePreview.valueChangeImage.overrideSprite = ValueChangePreview.instance.noChanges;
		}
	...
	void actualizePreviewElements(){
		if (UserInterface.valueChangePreview.valueChangeImage != null) {	
			UserInterface.valueChangePreview.valueChangeImage.overrideSprite = ValueChangePreview.instance.getPreviewSprite (nextValueChange.valueWasSetForChange,nextValueChange.valueChange, nextValueChange.randomIndependant);
	...
	public class valueLimits
	{
        ...
        [Tooltip("For initialization with random values: Round to whole numbers.")]
        public bool roundToWholeNumbers = true;
	}
	...
	public float setValue(float newValue){
        //Debug.Log(name + " set to " + newValue.ToString());
		value = newValue;
		limitValue ();
		saveValue ();
		return value;
    ...
    public float setValueRandom()
    {
        ...
        if(limits.roundToWholeNumbers == true)
        {
            value = (float)Mathf.RoundToInt(value);
        }

        //Debug.Log(name + " rnd:" + value.ToString());
        limitValue();
        saveValue();
        return value;
    }
